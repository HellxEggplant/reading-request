...
写完自己的中文翻译并生成参考译文后，点击“AI 校验并整合”。DeepSeek 会以英文原句和上下文为准，对两版译文进行核对，返回准确度评分、做得好的地方、误译或遗漏，以及一版整合译文。点击“采用这版译文”才会把整合结果填入自己的翻译框，网站不会自动覆盖原答案。

### AI 精灵

精读页面右下角提供“AI 精灵”。它会读取当前句、相邻句、当前译文和参考译文，可以连续询问词义、语法、结构、指代和翻译差异。切换文章时对话会清空，避免不同文章的上下文混在一起。
